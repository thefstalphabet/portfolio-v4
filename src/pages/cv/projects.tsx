      ...
      <div className="text-sm">
        <div>
          <div className="flex gap-1">
            <h5 className="font-semibold">Get Hired | </h5>
            <Link
              to="https://get-hired-mu.vercel.app/"
              target="_blank"
          ...
          <ul className="px-2">
            <div className="flex gap-2">
              <p>•</p>
              <li>Developing a SaaS Product for Recruiting Professionals.</li>
            </div>
            <div className="flex gap-2">
              <p>•</p>
              <li>
                Used React(vite) and ScadCn for developing user interfaces, and
        ...
        <div>
          ...
          <ul className="px-2">
            <div className="flex gap-2">
              <p>•</p>
              <li>
                Developing a SaaS product that offers working professionals and
