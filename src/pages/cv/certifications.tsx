    ...
    <div>
      ...
      <div className="text-sm">
        <div className="flex gap-2">
          <p className="font-semibold">Problem Solving (Basic) Certificate -</p>
          <Link
        ...
        <div className="flex gap-2">
          <p className="font-semibold">CSS (Basic) Certificate -</p>
          <Link
        ...
        <div className="flex gap-2">
          <p className="font-semibold">JavaScript (Basic) Certificate -</p>
          <Link
